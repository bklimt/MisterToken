...
namespace MisterToken {
    public class FourPieceLToken : Token {
        public FourPieceLToken(Board board, int row, int column, CellColor color1, CellColor color2, CellColor color3, CellColor color4) {
            ...
            cell4.direction = Cell.Direction.LEFT | Cell.Direction.UP;
            piece[0] = new TokenPiece(board, row, column + 2, cell1);
