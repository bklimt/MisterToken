...
namespace MisterToken {
    public class FourPieceJToken : Token {
        public FourPieceJToken(Board board, int row, int column, CellColor color1, CellColor color2, CellColor color3, CellColor color4) {
            ...
            cell2.direction = Cell.Direction.RIGHT | Cell.Direction.UP;
