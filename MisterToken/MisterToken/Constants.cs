...
namespace MisterToken {
    class Constants {
        public const int MILLIS_PER_REPEAT = 150;    // time between key presses when held down.
        ...
        public const int BOARD_RECT_X = 40;          // x offset for drawing the board.
        public const int BOARD_RECT_Y = 40;          // y offset for drawing the board.
        public const int BOARD_RECT_WIDTH = 200;     // width of the board in pixels.
        public const int BOARD_RECT_HEIGHT = 200;    // height of the board in pixels.
        ...
        public const int TOKEN_START_COLUMN = 19;    // column that new tokens should start in.
